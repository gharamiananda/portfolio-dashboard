...
const Register = () => {
    ...
    const[registerFn, {data,isError,error,isSuccess,isLoading}]=useRegisterMutation();
...
// toast.success('failed to');
  ...
  useEffect(()=>{
    if(isSuccess){
    const message = data?.message || 'User Register successful';
